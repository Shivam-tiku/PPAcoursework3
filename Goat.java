 ...
 * goats age, move, breed, eat plants and die.
 *
 * 
 */
public class Goat extends Prey
{
    ...
    // This is the number of steps a goat can go before it has to eat initially.
    private static final int INITIAL_HUNGER_VALUE = 8;
    // Nutritional value when eaten.
    private static final int FOOD_VALUE = 2;
    // This is the food level which a goat cannnot eat after because it's full.
    ...
    /**
     * Creates a new goat object.
     * @param randomAge If true, the goat will have random age and hunger level.
     * @param field The field currently occupied.
     * @param location The location within the field.
     * @return animal of type goat.
     */
    protected Animal getNewAnimal(boolean randomAge, Field field, Location loc)
    {
        Animal young;
        return young = new Goat(false, field, loc);
    }
